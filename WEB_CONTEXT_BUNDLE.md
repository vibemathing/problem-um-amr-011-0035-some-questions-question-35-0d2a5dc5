...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:um-amr-011-0035-some-questions-question-35-0d2a5dc5",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-011-0035-fadd177378e0",
        "url": "https://www.unsolvedmath.com/problems/AMR-011-0035"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Can every $d$-regular graphing without multiple edges be properly edge-colored by $d+1$ colors?",
      "version": 1
    },
    "title": "Some Questions — Question 35",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "5fe0d394ff6910d8ff274a0f23262c49fa0b0c4db43d0999626e5fe605358317"
}
```
